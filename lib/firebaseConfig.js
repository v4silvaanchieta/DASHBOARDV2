...
// IMPORTANTE: os dados estão no banco Firestore NOMEADO "velot" (não no "(default)").
// Sem o databaseId, o getDoc falha com "client is offline" / "sem documento".
export const db = getFirestore(app, "velot");
export default app;
